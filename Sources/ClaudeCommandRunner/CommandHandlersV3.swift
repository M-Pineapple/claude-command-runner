...
/// Safe version of execute command that doesn't crash the server
func handleExecuteCommandV3(params: CallTool.Parameters, logger: Logger, config: Configuration) async throws -> CallTool.Result {
    ...
    do {
        ...
        if process.terminationStatus == 0 {
            ...
            // DON'T start background monitoring - let the user retrieve output manually
            ...
            💡 After execution completes, use 'get_command_output' with the command ID to retrieve results.
            """
